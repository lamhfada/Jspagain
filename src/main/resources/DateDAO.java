...
public class DateDAO {
	...
	private static final String Check_date=
			"SELECT date FROM datetable WHERE date =?";
	//應該是建立..連線..
	...
	public boolean Exist(String name) throws IOException  {
	 ...
	 public void upinDateTable(oneDay od) throws IOException  {
	        Connection con = null;
	        PreparedStatement stmt = null;
	        ResultSet rs = null;
	        String today = od.getDate();
	        ...
	        try {
	            con = getConnection();	          
	            // Use the Connection to create a Statement object
	            stmt = con.prepareStatement(Check_date);            	 
	            stmt.setString(1, od.getDate()); 
